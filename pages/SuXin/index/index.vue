	...
	<view class="main">
		<view class="main-title">
			...
			<view class="bannerBox">
				<image class="bannerImg" :src="bannerUrl" mode="aspectFill"></image>
			</view>
			...
			<view class="searchBox">
				<uni-search-bar v-if="triggerSearch" style="flex:1;" v-model="searchValue" :radius="100"
					placeholder="搜索职位/公司" cancelButton="none" clearButton="auto" @confirm="getJobs" @clear="clearSearch"
					@cancel="cancelSearch">
				</uni-search-bar>
			</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				bannerUrl: 'https://xcx.wjhr.net/invertImg/xcx/wjbys/suxin/top3.png',
				searchValue: '',
				expectedJobs: [],
				currentJob: '',
				triggerSearch: true,
		...
		onLoad: function() {
			uni.setStorageSync("lastPage", '/pages/SuXin/index/index')
...
<style lang="scss" scoped>
	...
	.searchBox{
		background-image: linear-gradient(to bottom, rgba(0, 92, 232, 0.9), rgba(130, 202, 255,0.5));
	}
	.main {
		width: 100%;
		overflow: scroll;
